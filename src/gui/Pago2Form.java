 ...
 * @author danie
 */
public class Pago2Form extends JFrame implements ActionListener{
    ...
    public void assingC(CuentasApp cuentas){
    ...
    private void initComponent(){
        ...
        lSesion = new JLabel("Cirenia Monedero Espino");
        ...
        fondo = new JLabel();
        tNombre = new JTextField("Cirenia Monedero Espino");
        tCorreo = new JTextField("cireniamonederoespino@gmail.com");
        tCodigo = new JTextField("35012");
        tDomicilio = new JTextField("C/ Profesor reina, nº3, 12-A");
        tTelefono = new JTextField("689 28 96 77");
        tNTarjeta = new JTextField("5884 5678 0754 5644");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (botonPulsado == item4) {
            ...
            pago.assignDrugStore(farmacia, farmaciaform);
            pago.assing(cuentas);
            pago.showPriceTotal();
            farmaciaform.ponerNombre("");
        }
    }
    
    public static void main(String[] args){
        Pago2Form pagar = new Pago2Form();
    }
