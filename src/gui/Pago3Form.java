 ...
 * @author danie
 */
public class Pago3Form extends JFrame implements ActionListener{
    ...
    private void initComponent(){
        ...
        lSesion = new JLabel("Daniel Martinez Muñoz");
        ...
        fondo = new JLabel();
        tNombre = new JTextField("Daniel Martinez Muñoz");
        tCorreo = new JTextField("daniel_abeto@hotmail.es");
        tCodigo = new JTextField("35012");
        tDomicilio = new JTextField("AV/ Guillermo Santana Rivero, nº3, 6-F");
        tTelefono = new JTextField("690 88 82 16");
        tNTarjeta = new JTextField("5432 2000 0771 9815");
